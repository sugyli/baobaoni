...
class OutboxsController extends Controller
{
    ...
    public function store(OutboxRequest $request)
    {
        ...
        $url = $request->redirect_url ?: route('novel.outboxs.index');
    ...
    public function create(Request $request)
    {
        ...
        return view('jubao',compact('title','from','bkurl'));
    }
    ...
    public function index(){
      ...
      return view('useroutbox' , compact('user','bkurl'));
    }
    ...
    public function show($id){
        ...
        return redirect()->route('novel.outboxs.index');
    }
